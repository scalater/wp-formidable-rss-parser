...
<tr>
	...
	<td>
		<input type="text" name="field_options[rss_parser_match_<?php echo esc_attr( $field['id'] ) ?>]" id="field_options[rss_parser_match_<?php echo esc_attr( $field['id'] ) ?>]" value="<?php echo esc_attr( $field['rss_parser_match'] ) ?>"/>
	</td>
</tr>
