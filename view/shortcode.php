	...
	<label class="input-url">
		...
		<div class="search-container">
			<div class="input-outer">
				<input type="url" class="formidable-rss-parser" <?php echo esc_attr( $redirect ) ?> <?php echo esc_attr( $form_id_show ) ?> <?php echo esc_attr( $type ) ?> <?php echo esc_attr( $form_id_episode ) ?> id="field_<?php echo esc_attr( $html_id ) ?>" value="https://thenewsworthy.libsyn.com/rss">
